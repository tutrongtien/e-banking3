...
@section('content')
    <div id="test">
    	<form method="post" action="/transfer" id="form_transfer" class="well form-horizontal">
    		{{ csrf_field() }}
    		<fieldset>
    			<legend>Chuyển tiền đến một tài khoản ngoài Ngân Hàng</legend>
                ...
                <hr>
                 <!-- Ngân hàng chuyển -->
                <div class="form-group">
                    <label class="col-md-4 control-label">Tên ngân hàng</label>
                    <div class="col-md-4 inputGroupContainer">
                            <select name="account_id" class="form-control" id="bank_name">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4 inputGroupContainer" id="name">
                            <input  name="name" class="form-control" type="text" id="name_input">
                    </div>
                </div>
